...
class YAPLParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "CLASS", "ELSE", "FI", "IF", "IN", "LET", 
                      "INHERITS", "ISVOID", "LOOP", "POOL", "THEN", "WHILE", 
                      "NEW", "NOT", "TRUE", "FALSE", "TYPE_ID", "OBJECT_ID", 
                      "SELF", "SELF_TYPE", "LPAREN", "RPAREN", "LBRACE", 
                      ...
                      "STRING", "INT", "WHITESPACE", "COMMENT", "COMMENT_BLOCK", 
                      "ERROR" ]
    ...
    ruleNames =  [ "program", "classDef", "featureDef", "formalDef", "expr" ]
    ...
    class ExprContext(ParserRuleContext):
        ...
        def ASSIGN(self, i:int=None):
            if i is None:
                return self.getTokens(YAPLParser.ASSIGN)
            else:
                return self.getToken(YAPLParser.ASSIGN, i)
